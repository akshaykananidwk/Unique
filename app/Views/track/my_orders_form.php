...
<div class="container section" style="max-width:460px">
  <div class="track-box text-center">
    ...
    <form method="post" action="<?= e(base_url('my-orders')) ?>">
      <?= Csrf::field() ?>
      <input type="tel" name="phone" class="form-control form-control-lg text-center mb-3" maxlength="10"
             pattern="[0-9]{10}" inputmode="numeric" placeholder="10-digit mobile" required autofocus>
